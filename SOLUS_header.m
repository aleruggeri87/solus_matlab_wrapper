...
%This function was generated by loadlibrary.m parser version 1.1.6.36 on Wed Dec  4 19:21:25 2019
...
fcns.thunkname{fcnNum}='SOLUS_ReturnvoidPtruint8Thunk';fcns.name{fcnNum}='SOLUS_StopSequence'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='SOLUS_Return'; fcns.RHS{fcnNum}={'s_SOLUS_HPtr', 'uint8'};fcnNum=fcnNum+1;
...
structs.LD_parameters.members=struct('DELAY_F', 'uint16#8', 'DELAY_C', 'uint8#8', 'WIDTH_F', 'uint16#8', 'WIDTH_C', 'uint8#8', 'I_FINE', 'uint16#8', 'I_COARSE', 'uint8#8', 'CITR', 'uint8#4', 'SYNCD_F', 'uint16', 'SYNCD_C', 'uint8');
